...
export const STAKED_CMK_ADDRESSES: { [chainId: number]: string } = {
  [4]: '0xD6129eEB45164D8b576b4ACa3b21AeE2f5e5eDD5',
  [3]: '0x45F5aF4eBdA4747518799364B912423a3CF8aa88',
...
export const REWARDS_POOL_ADDRESSES: { [chainId: number]: string } = {
  [4]: '0xA5D5C8035eD8E4b5aB21A914Da01D90F612AE961',
  [3]: '0x7AdEd4c929cb560fE75163d92CBDF8F65EC896f9',
