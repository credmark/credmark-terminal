...
export const CREDMARK_ACCESS_KEY_ADDRESSES = {
  [4]: '0x005989cdc8C10E9ea9e1922794359FD3cc3e3F4b',
};

export const CREDMARK_ACCESS_FACTORY_ADDRESSES: { [chainId: number]: string } =
  {
    [4]: '0x071f1c40A96f6c5Dd1983F360A8A519C7B2e30E7',
  };
